...
namespace snapwatch.Engine.DataSet
{
    public class ToneDataSet
    {
        ...
        public HashSet<ushort> AnticipationGenresID { get; set; } = [27, 28, 9648, 10752, 53, 878, 37];
        public HashSet<ushort> JoyGenresID { get; set; } = [80, 16, 28, 35, 14, 12, 37];
        public HashSet<ushort> TrustGenresID { get; set; } = [36, 99, 10751, 10770, 10749, 37];
        public HashSet<ushort> SadnessGenresID { get; set; } = [18, 10749, 10402, 10751, 16, 37];
